...
export type { FrameMetadata, FrameMetadataPublishOptions, 
/** @deprecated Use {@link FrameMetadata} instead. */
PacketTrailerMetadata, 
/** @deprecated Use {@link FrameMetadataPublishOptions} instead. */
PacketTrailerPublishOptions, } from './frameMetadata/types';
export type { FrameMetadataOptions, PacketTrailerOptions } from './frameMetadata/FrameMetadataManager';
export { FrameMetadataManager, 
/** @deprecated Use {@link FrameMetadataManager} instead. */
PacketTrailerManager } from './frameMetadata/FrameMetadataManager';
...
export type { DataPublishOptions, SimulationScenario, TranscriptionSegment, ChatMessage, SendTextOptions, SendBytesOptions, ByteStreamInfo, } from './room/types';
export * from './version';
export { 
/** @internal */
