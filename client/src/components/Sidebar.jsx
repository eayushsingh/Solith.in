          ...
          return (
            <button
              ...
              className={`relative p-3 rounded-full transition-all duration-200 group flex items-center justify-center ${
                isActive 
                  ? 'text-[#00d859] border border-[#00d859]' 
      ...
      <div className="flex flex-col gap-4 w-full items-center mt-auto">
        ...
        {user ? (
          <div className="relative group mt-2">
            <button 
              className="w-10 h-10 rounded-full bg-[#2a2d36] border border-[#32363e] flex items-center justify-center text-white hover:border-[#00d859] transition-all"
